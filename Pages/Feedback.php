...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO feedback (student_id, feedback_text) VALUES ('$student_id', '$feedback_text')";
    if ($conn->query($sql)) {
...
<div class="row" style="display:flex;justify-content:space-between;padding:0px 10px;">
    ...
    <select class="form-control" name="student_id" required>
        ...
        <div class="col">
        <div class="form-group"> 
    <textarea class="form-control" rows="5" cols="100" id="comment" name="feedback_text" placeholder="Feedback" required></textarea>
    </div>
        </div>
    </div>

    <br>
    <button class="btn btn-primary btn-block" type="submit">Add Feedback</button>
</form>
